...
public class ProdutoResource {
    ...
    @GetMapping("/produtos")
    @Timed
    public ResponseEntity<List<ProdutoDTO>> getAllProdutos(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<ProdutoDTO>> searchProdutos(@RequestParam String query, @ApiParam Pageable pageable) {
