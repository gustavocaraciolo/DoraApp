...
public class CategoriaResource {
    ...
    @Timed
    public ResponseEntity<List<CategoriaDTO>> getAllCategorias(@ApiParam Pageable pageable, @RequestParam(required = false) String filter) {
    ...
    @Timed
    public ResponseEntity<List<CategoriaDTO>> searchCategorias(@RequestParam String query, @ApiParam Pageable pageable) {
