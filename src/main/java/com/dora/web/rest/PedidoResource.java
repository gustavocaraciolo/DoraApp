...
public class PedidoResource {
    ...
    @GetMapping("/pedidos")
    @Timed
    public ResponseEntity<List<PedidoDTO>> getAllPedidos(@ApiParam Pageable pageable) {
    ...
    public ResponseEntity<PedidoDTO> getPedido(@PathVariable Long id) {
        ...
        PedidoDTO pedidoDTO = pedidoService.findOne(id);
    ...
    @Timed
    public ResponseEntity<List<PedidoDTO>> searchPedidos(@RequestParam String query, @ApiParam Pageable pageable) {
